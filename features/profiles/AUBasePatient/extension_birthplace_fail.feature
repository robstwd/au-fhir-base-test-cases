  ...
  Rule: Extension in correct context: Patient
    ...
    Scenario: wrong context: child of Patient.address
      ...
      * extension "http://hl7.org/fhir/StructureDefinition/patient-birthPlace" is present in node "Patient.address"
      ...
      And "Error @ Patient.address" is raised with message "The modifier extension http://hl7.org/fhir/StructureDefinition/patient-birthPlace is not allowed to be used at this point (allowed = e:Patient; this element is [Patient.address, Address])"
    ...
    Scenario: wrong context: child of Patient.gender
      ...
      * extension "http://hl7.org/fhir/StructureDefinition/patient-birthPlace" is present in node "Patient.gender"
      ...
      And "Error @ Patient.gender" is raised with message "The modifier extension http://hl7.org/fhir/StructureDefinition/patient-birthPlace is not allowed to be used at this point (allowed = e:Patient; this element is [Patient.gender, code])"
    ...
    Scenario: wrong context: Practitioner
      ...
      * extension "http://hl7.org/fhir/StructureDefinition/patient-birthPlace" is present in node "Practitioner"
      ...
      Then the output will include the result "*FAILURE*: 1 errors"
      And "Error @ Practitioner" is raised with message "The modifier extension http://hl7.org/fhir/StructureDefinition/patient-birthPlace is not allowed to be used at this point (allowed = e:Patient; this element is [Practitioner])"
